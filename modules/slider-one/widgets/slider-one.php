...
class Slider_One extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
                'no_of_posts', [
            'label' => esc_html__('No of Posts', 'good-magazine-elements'),
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Post Excerpt', 'good-magazine-elements'),
                ]
        );

        $this->add_control('excerpt_length', [
            'label' => esc_html__('Excerpt Length', 'good-magazine-elements'),
            'type' => Controls_Manager::NUMBER,
            'min' => 0,
            'default' => 400
        ]);
        ...
        $this->start_controls_section(
                'carousel_section', [
            'label' => esc_html__('Carousel Settings', 'good-magazine-elements'),
        ...
        $this->add_control(
                'autoplay', [
            'label' => __('Autoplay', 'good-magazine-elements'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => __('Yes', 'good-magazine-elements'),
            'label_off' => __('No', 'good-magazine-elements'),
            'return_value' => 'yes',
            'default' => 'yes',
                ]
        );
        ...
        $this->add_control(
                'pause_duration', [
            'label' => __('Pause Duration', 'plugin-name'),
        ...
        $this->add_control(
                'nav', [
            'label' => __('Nav Arrow', 'good-magazine-elements'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => __('Show', 'good-magazine-elements'),
            'label_off' => __('Hide', 'good-magazine-elements'),
            'return_value' => 'yes',
            'default' => 'yes',
                ]
        );
        ...
        $this->start_controls_section(
                'section_post_extra', [
            'label' => esc_html__('Additional Settings', 'good-magazine-elements'),
                ]
        );
        ...
        $this->add_control(
                'image_height', [
            'label' => __('Image Height(%)', 'good-magazine-elements'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['%'],
            'range' => [
                '%' => [
        ...
        $this->start_controls_section(
                'heading_style', [
            'label' => __('Heading Text', 'good-magazine-elements'),
        ...
        $this->add_control(
                'heading_color', [
            'label' => __('Color', 'good-magazine-elements'),
        ...
        $this->add_group_control(
            ...
            'label' => __('Typography', 'good-magazine-elements'),
        ...
        $this->add_control(
                'heading_margin', [
            'label' => __('Margin', 'good-magazine-elements'),
        ...
        $this->start_controls_section(
                'content_box_style', [
            'label' => __('Content Box', 'good-magazine-elements'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => __('Background Color', 'good-magazine-elements'),
            'type' => Controls_Manager::COLOR,
            'scheme' => [
                'type' => Scheme_Color::get_type(),
                'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
                'nav_icon_color', [
            'label' => __('Navigation Icon Color', 'good-magazine-elements'),
            'type' => Controls_Manager::COLOR,
            'scheme' => [
                'type' => Scheme_Color::get_type(),
                'value' => Scheme_Color::COLOR_1,
        ...
        $this->start_controls_section(
                'title_style', [
            'label' => __('Post Title', 'good-magazine-elements'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->start_controls_section(
                'excerpt_style', [
            'label' => __('Post Excerpt', 'good-magazine-elements'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->start_controls_section(
                'meta_style', [
            'label' => __('Post Metas', 'good-magazine-elements'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
