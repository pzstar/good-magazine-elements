...
namespace GoodMagazineElements\Modules\GridTwo\Widgets;
...
class Grid_Two extends Widget_Base {
    ...
    public function get_name() {
        return 'gm-news-grid-two';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('News Grid Two', GME_TEXT_DOMAIN);
    }

    /** Icon */
    public function get_icon() {
        return 'gm-elements gm-grid-two';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .gm-post-grid-two' => 'gap: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
