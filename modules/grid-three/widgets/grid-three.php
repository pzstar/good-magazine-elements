...
namespace GoodMagazineElements\Modules\GridThree\Widgets;
 ...
 * Tiled Posts Widget
 */
class Grid_Three extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Grid Three', GME_TEXT_DOMAIN);
    }

    /** Icon */
    public function get_icon() {
        return 'gm-elements gm-grid-three';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .gm-post-list' => 'padding: calc( {{SIZE}}{{UNIT}}/2 );',
                '{{WRAPPER}} .gm-post-grid-three' => 'margin: calc( -{{SIZE}}{{UNIT}}/2 );',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute('gm-post-grid-three', 'class', [
            'gm-post-grid-three',
            'gm-row',
            'gm-col-' . $settings['column_count']['size'],
            'gm-tablet-col-' . $settings['column_count_tablet']['size'],
            'gm-mobile-col-' . $settings['column_count_mobile']['size']
                ]
        );
        ...
        <div class="gm-post-grid-block">
            ...
            <?php if ($post_query->have_posts()) : ?>
                <div <?php echo $this->get_render_attribute_string('gm-post-grid-three'); ?>>
                    <?php
