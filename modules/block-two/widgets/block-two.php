...
namespace GoodMagazineElements\Modules\BlockTwo\Widgets;
 ...
 * Tiled Posts Widget
 */
class Block_Two extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .gm-post-block-two .gm-top-block h3.gm-post-title a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', GME_TEXT_DOMAIN),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .gm-post-block-two .gm-top-block h3.gm-post-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .gm-post-block-two .gm-top-block h3.gm-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .gm-post-block-two .gm-bottom-block h3.gm-post-title a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', GME_TEXT_DOMAIN),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .gm-post-block-two .gm-bottom-block h3.gm-post-title a',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .gm-post-block-two .gm-bottom-block h3.gm-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .gm-post-block-two .gm-post-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', GME_TEXT_DOMAIN),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .gm-post-block-two .gm-post-excerpt',
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .gm-post-block-two .gm-post-meta span' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', GME_TEXT_DOMAIN),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .gm-post-block-two .gm-post-meta span',
                ]
        );
